    ...
    <div class="calendar-container" style="display: flex; gap: 20px; width: 100%; flex-direction: row; align-items: flex-start;">
        ...
        <div class="calendar-sidebar-right" style="flex: 1; display: flex; flex-direction: column; gap: 20px; min-width: 300px;">
            <div class="card-panel layout-vertical" style="background: #ffffff; padding: 20px; border-radius: 8px; border: 1px solid #e2e8f0;">
                ...
                <div class="form-group" style="margin-bottom: 10px;"><label style="font-size: 11px; font-weight: 600; color: #4a5568;">일정명</label><input type="text" id="cal-title" style="width: 100%; padding: 8px; border: 1px solid #cbd5e0; border-radius: 6px; margin-top: 4px; box-sizing: border-box;"></div>
                <div class="form-group" style="margin-bottom: 10px;"><label style="font-size: 11px; font-weight: 600; color: #4a5568;">시작일</label><input type="date" id="cal-start-date" style="width: 100%; padding: 8px; border: 1px solid #cbd5e0; border-radius: 6px; margin-top: 4px; box-sizing: border-box;"></div>
                <div class="form-group" style="margin-bottom: 10px;"><label style="font-size: 11px; font-weight: 600; color: #4a5568;">종료일</label><input type="date" id="cal-end-date" style="width: 100%; padding: 8px; border: 1px solid #cbd5e0; border-radius: 6px; margin-top: 4px; box-sizing: border-box;"></div>
                <div class="form-group" style="margin-bottom: 15px;"><label style="font-size: 11px; font-weight: 600; color: #4a5568;">URL</label><input type="url" id="cal-url" style="width: 100%; padding: 8px; border: 1px solid #cbd5e0; border-radius: 6px; margin-top: 4px; box-sizing: border-box;"></div>
